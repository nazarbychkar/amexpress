...
export default function Pagination({
  ...
  const getPageClassName = (pageNum: number) => {
    return `min-w-[36px] sm:min-w-[48px] px-3 py-2 sm:px-5 sm:py-3 rounded-xl sm:rounded-2xl border-2 text-sm sm:text-base font-bold transition-all duration-300 transform ${
      currentPage === pageNum
        ? "bg-gradient-to-br from-blue-950 via-blue-950 to-blue-950 text-white border-blue-950 shadow-xl scale-110 ring-2 ring-blue-400 ring-offset-2"
        : "bg-gradient-to-br from-white to-gray-50 text-gray-700 border-gray-300 hover:from-blue-950 hover:to-blue-950 hover:text-white hover:border-blue-950 shadow-lg hover:shadow-xl hover:scale-105 hover:-translate-y-0.5"
    }`;
  };
      ...
      <div className="flex justify-center items-center flex-wrap gap-3">
        ...
        {currentPage > 1 && (
          <Link
            ...
            className="group px-3 py-2 sm:px-4 sm:py-3 rounded-xl sm:rounded-2xl border-2 bg-gradient-to-br from-white to-gray-50 text-gray-700 border-gray-300 hover:from-blue-950 hover:to-blue-950 hover:text-white hover:border-blue-950 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
          >
            <svg
